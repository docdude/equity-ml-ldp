...
from tensorflow.keras.layers import Input, Conv1D, Multiply, Add, Concatenate, Dense, Embedding, Reshape, Dropout
...
def build_swim_generator(time_steps=180, nfilt=32, num_styles=6, seed=1337):    
   ...
   # style_embedded = Embedding(input_dim=6, output_dim=4)(swim_style_input)
    ...
    swim_style_embedding = Reshape((180, 8), name='gen_swim_reshape')(swim_style_embedding)
    ...
    stroke_embedding = Reshape((180, 4), name='gen_stroke_reshape')(stroke_embedding)
