# tune_cnn_validate_all.py - Fixed version with correct metrics
...
def validate_all_trials(input_shape, training_parameters, data_parameters, num_trials=200):
    ...
    for trial_id in range(num_trials):
        try:
            ...
            print(f"⚠️ Trial {trial_id:3d}: Error - {str(e)}")
...
if __name__ == '__main__':
    ...
    if invalid_trials and len(invalid_trials) > 20:  # If more than 10% fail
        print("\n" + "="*80)
        print("CRITICAL: Too many invalid configurations!")
        print("="*80)
        print("\nUpdate your tune_cnn.py file immediately with these safer ranges.")
        print("The current hyperparameter ranges will cause many trials to fail.")
