...
print("="*80)
X1, y1, dates1, ldp1, ret1, feature_names = load_or_generate_sequences(
    tickers=['AAPL'],
...
print("="*80)
X2, y2, dates2, ldp2, ret2, feature_names = load_or_generate_sequences(
    tickers=['AAPL'],
    config_preset='wavenet_optimized',
    barrier_params={'pt_sl': [2, 1], 'min_ret': 0.005, 'num_days': 7, 'lookback': 60},
    seq_len=20,
...
print("="*80)
X3, y3, dates3, ldp3, ret3, feature_names = load_or_generate_sequences(
    tickers=['AAPL'],
    config_preset='wavenet_optimized',
    barrier_params={'pt_sl': [2, 1], 'min_ret': 0.005, 'num_days': 7, 'lookback': 60},
    seq_len=20,
